# Contributing to LightningGrim

Thank you for your interest in contributing to LightningGrim. This document outlines the guidelines for
making pull
...
- LightningGrim is built using [Gradle](https://gradle.org/) kotlin scripts.
